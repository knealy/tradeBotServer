...
class OpeningRangeBreakoutStrategy(BaseStrategy):
    ...
    def __init__(self, trading_bot, config: Optional[StrategyConfig] = None):
        ...
        # Whether we've registered for the consec-loss breaker bridge.
    ...
    def _maybe_register_breaker(self) -> None:
        ...
        try:
            ...
            logger.debug("opening_range_breakout: breaker registration skipped: %s", exc)
    ...
    def _evaluate_breaker(self, symbol: str, sess_date: date) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.debug("opening_range_breakout: breaker eval failed: %s", exc)
            return {"blocked": False}
