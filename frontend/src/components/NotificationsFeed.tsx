  ...
  return (
    <div className="fixed right-4 top-20 z-40 w-80">
      <button
        ...
        className={`w-full flex items-center justify-between px-4 py-2 rounded-t-lg border transition-colors ${
          isOpen
      ...
      {isOpen && (
        <div className="bg-slate-800 border-x border-b border-slate-600 rounded-b-lg shadow-xl max-h-[32rem] flex flex-col">
          {isLoading ? (
